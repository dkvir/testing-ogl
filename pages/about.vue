<template>
  <div class="about-page">
    <ul class="list flex">
      <li
        v-for="(item, index) in 1001"
        :class="['item flex-center', { 'is-active': activeCard == index }]"
        @click="clickCard(index)"
      >
        <div class="card">
          <div class="front">
            <img
              :src="`https://d3l19dpo35tmza.cloudfront.net/${index + 1}.png`"
              alt=""
              class="img"
            />
            <div class="text">Card {{ index + 1 }}</div>
          </div>
